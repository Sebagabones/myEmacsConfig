;;; doom-tokyo-dark-theme.el --- inspired by VSCode's Tokyo Night theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: December 15, 2021 (#650)
;; Author: FosterHangdaan <https://github.com/FosterHangdaan>
;; Maintainer:
;; Source: https://github.com/enkia/tokyo-dark-vscode-theme
;;
;;; Commentary:
;;; Code:
...
(def-doom-theme doom-tokyo-dark
  ...
  ;; name         default   256       16
  ((bg         '("#11121d" nil       nil            )) ; base00 (Default Background)
   (bg-alt     '("#1a1b2a" nil       nil            )) ; base01 (Lighter Background)
   (base0      '("#2f3549" "#2f3549" "black"        )) ; base02 (Selection Background)
   (base1      '("#444b6a" "#444b6a" "brightblack"  )) ; base03 (Comments, Invisibles)
   (base2      '("#535977" "#535977" "brightblack"  )) ; Gradient Step
   (base3      '("#656b88" "#656b88" "brightblack"  )) ; Gradient Step
   (base4      '("#787c99" "#787c99" "brightblack"  )) ; base04 (Dark Foreground)
...
;;; doom-tokyo-dark-theme.el ends here
